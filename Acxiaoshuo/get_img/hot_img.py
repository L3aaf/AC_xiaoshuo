...
class Hot_img:
    def get_img_links(self):
        ...
        for title in title_list:
            html_content = ua.read_html('hot/', title)
    ...
    def download_all_img(self):
        ...
        for src, alt in zip(src_list, alt_list):
            ua.set_url(src[0])
            save_path = os.path.join(r'C:\Users\86132\PycharmProjects\pythonProject\Acxiaoshuo\download\html\img\hot',
                                     f'{alt[0]}.jpg')
