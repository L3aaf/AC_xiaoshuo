# _*_coding:utf-8
# @Time      :2023/11/26 5:16
# @Author    :DQ
# @FileName: newest_novel.py
...
class novel:
    ...
    def get_links(self):
        ...
        # 使用 XPath 获取排序链接和标题
        sort_links = tree.xpath(r'/html/body/div[4]/aside/ul/li[/]/a[1]/@href')
        sort_title = tree.xpath(r'/html/body/div[4]/aside/ul/li[/]/a[1]/text()')
    ...
    def get_content(self):
        ...
        for index, title_list in enumerate(titles_list, start=2):
            html_content = ua.read_html('novel/', title_list)
            tree = html.fromstring(html_content)
